...
\newcommand{\thesistitle}{ Inferring the 3D gravitational potential of the Milky Way \\ with stellar streams }
...
% (introduction, chapters, conclusions)
{
	...
	\input{chapters/ch2_rewinder1}
	\input{chapters/ch3_rewinder2}
	\input{chapters/ch4_morphology}
	\input{chapters/ch5_ophiuchus}
