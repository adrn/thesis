...
intrinsically bright and good distance indicators \cite[$\sigma_{d}/d \approx
10\%$; see, e.g.,][]{xue08, deason11}; outside of $\approx$4 kpc, \gaia\
...
extreme distances because of their large luminosities ($M_V \approx 1$--$-3$).
...
of \mwhalo\ stars with radial velocity measurements is a factor of \todo{XX}
...
Copenhagen survey \citep{todo}, a significant amount of velocity substructure
was uncovered even in this small volume \citep[e.g.,][]{bovy09, minchev10}. The
\gaia\ mission will provide this kind of revelation for the Milky Way \mwhalo.
...
still be useful for nearly $\approx$$10^{9}$ stars. Figure~\ref{XX} shows a
summary of the expected distance and tangential velocity uncertainties for each
of the stellar tracers reviewed in the previous section. \todo{explain figure
more...}
