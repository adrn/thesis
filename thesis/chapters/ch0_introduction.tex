...
combined;][]{todo}. The existence of substructure has been shown to bias mass
inferences made with random-tracer methods by up to 20\%
...
\citep{todo}. These stars are very useful for studying the halo because they are
intrinsically bright and good distance indicators \cite[see, e.g.,][]{xue08,
deason11}; outside of $\approx$4 kpc, \gaia\ parallaxes uncertainties will be
worse than photometric distance measurements for BHB stars.
...
extensively to map the structure of the halo \citep[e.g.,][]{sesar13}.

Red clump (RC) stars form the metal-rich end of the HB and lie near the giant branch because these stars lose less of their envelopes before the core begins helium burning. Distance measure

bovy14-rc

HB stars (BHB, RRL, RC) are considerably less numerous than MSTO stars; a typical metal-poor globular cluster will contain a few to a few tens of HB stars but will contain thousands of MSTO stars. However, because of their luminosity and significantly smaller distance uncertainties, these are extremely powerful tracers.

what tracers:
- MSTO: most numerous, but faint. large spread in abs. mag.
- BHB: bright HB stars. metallicity dependent, but trace low metallicity dwarfs. contamination with other blue stars
- RRL: pulsating HB stars. metallicity dependent. easy to identify in time series because of light curve
- Red clump: bright red giant stars. evolved, helium burning. after ascending RGB, get stuck?
- K giants: TODO (Xue 14)
- M giants: TODO

Hipparcos
2MASS
SDSS -- photometry then SEGUE and APOGEE
RAVE
