...
orbits of halo stars and will be largely ignored in this \article. %\citep[$M_{\rm h:g} \approx 10^{10}~\msun$;][]{blitz00, salem15}
...
{\bf Horizontal branch (HB)} stars are considerably less numerous than MSTO
...
{\bf Red giant (RG)} stars are present in old stellar populations and can be
...
tangential velocity measurements from the \project{Hipparcos} mission
...
\centering
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/ch0/frac-plx-err.pdf}
    }
    \subfloat{
      \includegraphics[width=0.45\textwidth]{figures/ch0/vtan-err.pdf}
    }
...
In Chapter~\ref{ch:chaos-ophiuchus}, we study a particular stellar stream---the
