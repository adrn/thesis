...
\label{ch:rewinder2}
\let\thefootnote\relax\footnotetext{This section contains text from an article published in The Astrophysical Journal, Volume 794, Issue 1, article id. 4, 15 pp. (2014). Portions of this paper's introduction now appear in the introduction to this dissertation.}
