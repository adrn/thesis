...
% TODO: \todo{Looking at what was resubmitted, some references are arxiv and should be journal. Check against more recent refs file}
...
In this \emph{Letter} we re-examine and update a complimentary approach that uses tidal debris as a potential measure \citep[originally proposed by][]{johnston99a}  in the context of current and near-future observational capabilities, and apply it to a simulation of the Sagittarius debris system (hereafter Sgr).
